package screens
{
	...
	public class Muistipeli extends Sprite
	{
		...
		private function makeArrays():void
		{
			...
			cardListKuva.push(nokkosperhonenText);
			...
			cardListKuva.push(sitruunaperhonenText);
